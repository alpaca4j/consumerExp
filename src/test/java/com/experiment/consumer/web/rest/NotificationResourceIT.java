...
class NotificationResourceIT {
    ...
    void createNotification() throws Exception {
        ...
        assertThat(testNotification.getOrigin()).isEqualTo(DEFAULT_ORIGIN);
    ...
    void putNewNotification() throws Exception {
        ...
        assertThat(testNotification.getOrigin()).isEqualTo(UPDATED_ORIGIN);
    ...
    void partialUpdateNotificationWithPatch() throws Exception {
        ...
        partialUpdatedNotification.level(UPDATED_LEVEL);
