...
@RestController
@RequestMapping("/api/consumer-exp-kafka")
public class ConsumerExpKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ConsumerExpKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ConsumerExpKafkaResource(KafkaProperties kafkaProperties) {
